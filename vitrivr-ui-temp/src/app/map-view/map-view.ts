import { Component, AfterViewInit, OnDestroy, ElementRef, HostListener, Input, Output, EventEmitter, OnInit } from '@angular/core';
 ...
 * - TODO: View search results (future functionality)
 *
